...
public class Starter extends jade.core.Agent {
	...
	// On fait tourner un certain nombre d'agents Person, mais ces agents
	// peuvent représenter plusieurs personnes réelles
	// pour alléger la simulation. Ceci intervient dans l'encombrement des
	// routes.
